...
exports.config = {
   ...
   framework: 'jasmine',
       ...
       specs:['./specs/ORR/login.spec.js','./specs/ORR/customerImport.spec.js','./specs/ORR/productSkuImport.spec.js','./specs/ORR/inventoryImport.spec.js','./specs/ORR/inventoryInc.spec.js'],
       baseUrl: 'https://orr165-qa.enspirecommerce.com/oms/dist/#/',
    getPageTimeout: 1280000,

    //--
    params: {
        login: {
          user: 'sbabu@orrsafety.com',
          password: 'mypassword',
        },

        catalog: 'OrrSafetyCatalog',
        catalogCategoryName: 'General',
        orgName: 'OrrSafety-Organization-',
        carrier: 'FEDEX',
        serviceType: 'FedExGround',
        dataDomain: 'com.orrsafety'
    },
