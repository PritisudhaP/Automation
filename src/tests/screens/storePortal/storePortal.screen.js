module.exports = function () {
    ...
    // var FRSelectGearIcon = element(by.xpath("//div[@class='en-collection-row']/div[2]//en-actions/button"));
    ...
    var valueDropDown = element(by.xpath("//select[contains(@ng-if,'filterType')]"));
