...
describe('Verify  if user can Partially  accept the orders (Accept Partial-Pick Partial)-MULTIPLE LINES: TC00019', function () {
   ...
   it('Sales Order that  order that release, Accept Partial,Pick Partial & finalize shipment successfully - - TC00019', function () {
        /* ************************************************************
                   Creates a sales order with a multiple lines say 3 lines and releases it.
                   Accept the Fulfillment request partially(reject 1 line). In pack & ship screen, reject 1 line and accept 1 line , finalize the shipment.
  ...
  /*      browser.get(salesOrderUrl);
        ...
        console.log("Executing Accept partial pick partial Multiple lines spec");
