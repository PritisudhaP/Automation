...
global.descTextVal = "";
describe('Sales Order creation Via call center and RMA creation: single line order : Return-Vendor portal-00102', function () {
...
//callCenter.incrementQty();
        ...
        browser.wait(function () {
            ...
            browser.sleep(3000);
            //callCenter.accountSelection("test");
            browser.sleep(3000);
...
//*****<<<<< Validation tax to be non-zero  >>>>******
                returnsvdp.getTaxDiscount(5).then(function (value) {
                    tax = value.substring(3,6);
                    console.log("tax",+tax);
