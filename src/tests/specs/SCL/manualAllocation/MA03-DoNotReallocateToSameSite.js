...
describe('Manual Allocation E2E flow ', function() {
    ...
    /*
     ...
     prereq:: In channels screens set the flag: Avoid reallocation to same site
      ...
      4. Re-release line2 through manual allocation, order should move to FTA.
     */
    ...
    it('Manually allocate sku to desired pool and complete shipment - TC003', function () {
        ...
        browser.sleep(2000);
        commons.searchWithCriteria('Name', 'contains', 'B2B');
        browser.sleep(2000);
        callCenter.clickOnEditChannelSettings();
        browser.sleep(1000);
        callCenter.selectOptionInChannelScreen();
        browser.sleep(2000);
        callCenter.saveChannel();
        browser.sleep(3000);
