...
var d = new Date();
var curr_date = d.getDate() +d.getMonth() +d.getFullYear()+ d.getMonth() + d.getHours() +d.getMinutes()+ d.getSeconds();

var orderNumber = "testNivee " + curr_date ;
...
describe( "test", function () {
    var options = {
        ...
        headers: {
            ...
            'Authorization': 'Bearer bd7a5529-d0e2-409c-b12b-e7024f576a8e'
        },
        body: {
            "orders": [
                {
    ...
    it("create SO", done =>{
        ...
        request(options, function (error, response, body) {
            ...
            console.log('stringified body:::' +myJSON);
            var res = myJSON.substring(18, 54);
            console.log("resid:::" +res);
            global.newGlobalVar = res;
            //return errors;
            done();
