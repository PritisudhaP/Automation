...
describe('Order Line Cancel ', function () {
  ...
  it('canceling 2 digit QTY at Header Level ', function () {
      ...
      browser.sleep(300);
		...
		browser.wait(function () {
	       ...
	       //browser.sleep(1000);
	        ...
	        browser.sleep(1000);
	        expect(salesOrderSummary.OrderStatusDetails(2)).toEqual("CANCELLED");//after completely canceling the line item
	 ...
	 it('canceling 2 digit QTY at Line Level ', function () {
