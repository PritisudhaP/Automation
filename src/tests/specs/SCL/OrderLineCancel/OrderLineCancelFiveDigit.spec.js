...
describe('Order Line Cancel ', function () {
  ...
  it('canceling 5 digit QTY at Header Level ', function () {
      ...
      salesOrderCreate.invCountcheck().then(function (totalAvailableValue) {
          ...
          salesOrderCreate.entryAdjustment(ATS1,57000,"Test Adjustment");//(available,entry need to get Adjusted,Reason)
          browser.sleep(5000);
      });    
      ...
      browser.sleep(1000);
      callCenter.editSKUQuantity(52000);
      browser.sleep(1000);
	 ...
	 it('canceling 5 digit QTY at Line Level ', function () {
	      ...
	      callCenter.lineItemselectOptions("Edit Line");
	      browser.sleep(1000);
	      callCenter.editSKUQuantity(53000);
	      browser.sleep(1000);
	      callCenter.editLinePopUpSaveBtn();      
	      //!***************<<<< Below line is to SAVE the sales order >>>>>>********************
	      browser.sleep(300);
