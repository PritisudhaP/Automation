...
// var validateStat = require(process.cwd()+'/screens/mixedOrder/validateMO_Status.js');
 ...
 it('Cancel FTA line sku', function() {  //pass
...
//     //Cancel FTA line
	soOrderLoc.firstmorebutton.click();
	soOrderLoc.cancelline.click();
	browser.actions().doubleClick(soOrderLoc.plusicon).perform();
	soOrderLoc.cancelreasondropdown.sendKeys('NotNeeded');
	soOrderLoc.confirmbutton.click();
	browser.sleep(5000);
