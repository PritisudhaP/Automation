...
describe('Sales Order Flow - update address on released order : ', function(){
    var salesOrderCreate = new salesOrderCreateScreen();
    var salesOrderEdit = new salesOrderEditScreen();
    var salesOrderSummary = new salesOrderSummaryScreen();
    var commons = new common();

        it('Sales order - update address on released order - TC0001', function(){
...
//                salesOrderSummary.salesOrderSearch("Original Order #", SONumber);
                ...
                salesOrderEdit.salesOrderEditCarrier("FEDEX","FedExPriorityOvernight");
                expect(salesOrderEdit.salesOrderCarrierUpdateFromWMS()).toMatch('was successful');
