...
//                commons.searchWithCriteria("Order #","contains",SONumber);
            ...
            browser.wait(function() {
                ...
                var fs1 = require('fs');
                var filename1 = './autoFiles/ShipConfirm_SingleLine.XML';
                ...
                browser.wait(function() {
                    ...
                    stringSearcher.find(content,"<orderNumber>.*</orderNumber>").then(function(resultArr) {
                        ...
                        replace1({
                            ...
                            paths: ['./autoFiles/ShipConfirm_SingleLine.XML'],
                            recursive: true,
                            silent: true,
                        });
                    });
...
//                commons.searchWithCriteria("Order #","contains",SONumber);
            ...
            browser.wait(function() {
                ...
                var stringSearcher = require('string-search');
                var fs1 = require('fs');
                var filename1 = './autoFiles/ShipConfirm_SingleLineZeroQty.XML';
                ...
                browser.wait(function() {
                    ...
                    stringSearcher.find(content,"<orderNumber>.*</orderNumber>").then(function(resultArr) {
                        ...
                        replace1({
                            regex: currentSONumber,
                            replacement: replaceString1,
                            paths: ['./autoFiles/ShipConfirm_SingleLineZeroQty.XML'],
                            recursive: true,
                            silent: true,
                        });
                    });
...
//                commons.searchWithCriteria("Order #","contains", SONumber);
            ...
            browser.wait(function() {
                ...
                var stringSearcher = require('string-search');
                var fs1 = require('fs');
                var filename1 = './autoFiles/ShipConfirm_TwoLines.XML';
                ...
                browser.wait(function() {
                    ...
                    stringSearcher.find(content,"<orderNumber>.*</orderNumber>").then(function(resultArr) {
                        ...
                        replace1({
                            regex: currentSONumber,
                            replacement: replaceString1,
                            paths: ['./autoFiles/ShipConfirm_TwoLines.XML'],
                            recursive: true,
                            silent: true,
                        });
                    });
...
//                commons.searchWithCriteria("Order #","contains",SONumber);
            ...
            browser.wait(function() {
                ...
                var stringSearcher = require('string-search');
                var fs1 = require('fs');
                var filename1 = './autoFiles/ShipConfirm_DiffLots.XML';
                ...
                browser.wait(function() {
                    ...
                    stringSearcher.find(content,"<orderNumber>.*</orderNumber>").then(function(resultArr) {
                        ...
                        replace1({
                            regex: currentSONumber,
                            replacement: replaceString1,
                            paths: ['./autoFiles/ShipConfirm_DiffLots.XML'],
                            recursive: true,
                            silent: true,
                        });
                    });
...
//                commons.searchWithCriteria("Order #","contains",SONumber);
            ...
            browser.wait(function() {
                ...
                var stringSearcher = require('string-search');
                var fs1 = require('fs');
                var filename1 = './autoFiles/ShipConfirm_TwoLines_MultiSKU.XML';
                ...
                browser.wait(function() {
                    ...
                    stringSearcher.find(content,"<orderNumber>.*</orderNumber>").then(function(resultArr) {
                        ...
                        replace1({
                            regex: currentSONumber,
                            replacement: replaceString1,
                            paths: ['./autoFiles/ShipConfirm_TwoLines_MultiSKU.XML'],
                            recursive: true,
                            silent: true,
                        });
                    });
