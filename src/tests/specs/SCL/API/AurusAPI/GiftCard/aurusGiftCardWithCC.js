...
describe( "order creation", function () {
	Amount = parseFloat(browser.params.Amount) + parseFloat(browser.params.Amount1);
    ...
    var options = {
       ...
       body: {
    	   "orders": [
    		    {
    		      "orderDate": browser.params.orderDate,
    		      ...
    		      "orderPayments": [
    		        {
    		         ...
    		         {
    		          "status": "authorized",
    		          "transactionDate": "2020-07-12T00:00:00",
    		          ...
    		          "orderPaymentTransactions": [
    		            {
    		              ...
    		              "pnRef": browser.params.TransactionID1,
    		              "authorizedAmount": browser.params.Amount1,
    		              "transactionExpirationDate": "2020-07-12T00:00:00",
    		              "referenceData": [],
