...
describe('Inventory daily Import  : ', function(){
    ...
    var inventorySearch = new inventorySearchScreen();
        ...
        it('Inventory daily import  - TC0001', function(){
            ...
            browser.get(routeUrl);
            browser.sleep(5000);
            commons.searchWithCriteria("Name","contains","Inventory-inventorySync");
            browser.sleep(5000);
            route.routeSelectButton("Start");
            browser.sleep(5000);
            commons.refresh();
            ...
            browser.sleep(2000);
            expect(inventorySearch.getAvailableQty()).toEqual('1000');
          //  expect(inventorySearch.getReservedQty()).toMatch("10");
            ...
            inventorySearch.searchInventory();
            browser.sleep(2000);
            expect(inventorySearch.getAvailableQty()).toEqual('900');
          //  expect(inventorySearch.getReservedQty()).toMatch("10");
            browser.sleep(2000);
