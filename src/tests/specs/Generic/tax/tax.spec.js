var taxAgencyCreateScreen = require(process.cwd() + '/src/tests/screens/tax/taxAgency.create.screen.js');
var taxAgencySummaryScreen = require(process.cwd() + '/src/tests/screens/tax/taxAgency.summary.screen.js');
var taxCodeCreateScreen = require(process.cwd() + '/src/tests/screens/tax/taxCode.create.screen.js');
var taxCodeSummaryScreen = require(process.cwd() + '/src/tests/screens/tax/taxCode.summary.screen.js');
var taxLocationCreateScreen = require(process.cwd() + '/src/tests/screens/tax/taxLocation.create.screen.js');
var taxLocationSummaryScreen = require(process.cwd() + '/src/tests/screens/tax/taxLocation.summary.screen.js');
var taxRateCreateScreen = require(process.cwd() + '/src/tests/screens/tax/taxRate.create.screen.js');
var taxRateSummaryScreen = require(process.cwd() + '/src/tests/screens/tax/taxRate.summary.screen.js');
