...
describe('Inventory Publish Flow ', function(){
  ...
  /* it('Inventory publish Full Sync-Inventory Pool TC0001', function(){
      ...
      browser.sleep(2000);
       ...
       browser.get(inventorypublishUrl);
        ...
        inventorypublishcreate.enterName('TC001');
       ...
       browser.get(inventorypublishUrl);
       browser.sleep(3000);
       inventoryPublishsummary.searchInput('TC001');
       browser.sleep(1000);

       inventoryPublishsummary.clickPublish();
       inventoryPublishsummary.expandPlusBlock();
       browser.sleep(5000);
       inventoryPublishsummary.CheckStatus().then(function(status){
       statusOfPublish =status;
       expect(statusOfPublish).toEqual('COMPLETED');
       });
 ...
 it('Inventory publish Full Sync-Item Pool TC0002 ',function(){
    ...
    browser.get(inventorypublishUrl);
     browser.sleep(900);
     inventoryPublishsummary.clicknewButton();
     inventorypublishcreate.enterName('TC002');
     inventorypublishcreate.clickactivecheckbox();
     inventorypublishcreate.setPublishMode('Full Sync');
    ...
    browser.get(inventorypublishUrl);
    browser.sleep(3000);
    inventoryPublishsummary.searchInput('TC002');
    browser.sleep(1000);
    //inventoryPublishsummary.searchInput('TC002');
    inventoryPublishsummary.clickPublish();
    inventoryPublishsummary.expandPlusBlock();
 ...
 */
  ...
  it('Inventory publish Full Sync-SIte TC0003 ',function(){
    ...
    /* browser.get(inventorypublishUrl);
      browser.sleep(900);
      inventoryPublishsummary.clicknewButton();
      inventorypublishcreate.enterName('TC003');
      inventorypublishcreate.clickactivecheckbox();
      inventorypublishcreate.setPublishMode('Full Sync');
    ...
    inventorypublishcreate.clickexcludeInactiveItem();
     ...
     browser.get(inventorypublishUrl);
     browser.sleep(3000);
     inventoryPublishsummary.searchInput('TC003');
     browser.sleep(1000);
     //inventoryPublishsummary.searchInput('TC003');
     inventoryPublishsummary.clickPublish();
     ...
     inventoryPublishsummary.expandPlusBlock();
     browser.sleep(3000);
     inventoryPublishsummary.CheckStatusISCompletedORNOT();
