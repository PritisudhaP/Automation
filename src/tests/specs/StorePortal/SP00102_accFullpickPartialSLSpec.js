...
//var loginPage = require(process.cwd() + '/screens/storePortal/testLoginScreen.js');
var common = require(process.cwd() + '/screens/commons.js');
var inventorySearchScreen = require(process.cwd() + '/screens/inventorySearch/inventorySearch.summary.screen.js');

var purchaseOrderCreateScreen = require(process.cwd() + '/screens/purchaseOrder/purchaseOrder.create.screen.js');
var purchaseOrderEditScreen = require(process.cwd() + '/screens/purchaseOrder/purchaseOrder.edit.screen.js');
var purchaseOrderSummaryScreen = require(process.cwd() + '/screens/purchaseOrder/purchaseOrder.summary.screen.js');
