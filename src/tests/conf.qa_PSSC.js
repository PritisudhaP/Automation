...
exports.config = {
   directConnect: true,
   framework: 'jasmine', 
     specs:['./specs/PSSC/login.spec.js','./specs/PSSC/setup.spec.js','./specs/PSSC/importcustomer.spec.js','./specs/PSSC/productImport.spec.js','./specs/PSSC/customerLedger.spec.js','./specs/PSSC/salesOrder.spec.js','./specs/PSSC/shipmentConfirmation.spec.js','./specs/PSSC/inventoryIncDec.spec.js','./specs/PSSC/workOrder.spec.js','./specs/PSSC/expectedReceipt.spec.js','./specs/PSSC/salesOrderBulkRelease.spec.js','./specs/PSSC/expectedReceiptBulkRelease.spec.js','./specs/PSSC/salesOrderMultiTenancy.spec.js','./specs/PSSC/teardown.spec.js'],

//     specs:['./specs/PSSC/login.spec.js','./specs/PSSC/salesOrderBulkRelease.spec.js'],
