...
exports.config = {
  ...
  specs: [//'./specs/SCL/API/tokenGeneration.js',
   './specs/SCL/invoice/Invoice_High.spec.js',
	  //'./specs/SCL/invoice/Invoice_Medium.spec.js',
	//  './specs/SCL/invoice/Invoice_Low.spec.js'
	  ],
  // specs: ['./specs/SCL/API/tokenGeneration.js','./specs/SCL/invoice/Invoice_Medium.spec.js'],
 // specs:['./specs/SCL/API/tokenGeneration.js','./specs/SCL/invoice/Invoice_Low.spec.js'], 
//  specs:[//'./specs/SCL/API/tokenGeneration.js',
	//  './specs/SCL/batchPick/roughwork.spec.js'], 
...
// baseUrl: 'https://project5-qa.enspirecommerce.com/oms/dist/#/',
    ...
    params: {
        ...
        SkuName3 :'CivicSku3',   
        searchValueSKU4:'CivicSku4',
        SkuName4 :'CivicSku4',  
        vendorSku:'SKU3620',
        customerCriteria:'Name',       
        customerSearchValue:'STEVE SMITH',
        channelName:'B2B',
        channelName1:'B2C',
		...
		purchaseDate:"2021-11-25T16:40:02.057-05:00",
		paymentJob : "capturePaymentAtInvoiceTaskletJobPaypal",
		fullFillmentType : 'Pick Up At Store',
		availableStore : 'sandiego-dc , Avl Qty :',
		trackingNumber : '1234567890',
		reshipreasoncode:'delayed',
		returnpaymentJob:'refundPaymentAtInvoiceTaskletPaypal',
		giftcardNumber : '7777191949639426',
        giftcardAmount : '20.00',
        giftcardPin : '9013',
        data:"20200309619395365396",
        txnId:"20200309619395365397",
        orderType: 'SubscriptionOrder',
        subscription:"WEEKLY",
        subscriptionJob:"BatchReleaseSubscriptionOrderJob",
        subscriptionpastdate :"2021-10-25"
