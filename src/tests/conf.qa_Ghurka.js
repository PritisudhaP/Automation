...
exports.config = {
   directConnect: true,
   framework: 'jasmine',
   specs:['./specs/Ghurka/login/login.spec.js', './specs/Ghurka/*/*.js'],
//   baseUrl: 'http://oms144-dev.enspirecommerce.com/oms/dist/#/',
    baseUrl: 'https://project5-qa.enspirecommerce.com/dist/#/',
    getPageTimeout: 1280000,

    //--
    params: {
        login: {
//          ghurkauser: 'admin@ghurka.com',
          ghurkauser:  'admin@thk.com',
          password: 'mypassword',
          firstName: 'Admin Ghurka'
        },

        catalog: 'GhurkaCatalog',
        orgName: 'GhurkaOrganization',
        carrier: 'FEDEX',
        serviceType: 'FedEx 2Day',
        dataDomain: 'com.ghurka'
    },
